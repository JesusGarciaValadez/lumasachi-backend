...
'octane.garbage','octane.max_execution_time','pennant.default','pennant.stores.array.driver','pennant.stores.database.driver',
'pennant.stores.database.connection','pennant.stores.database.table','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'scramble.ui.try_it_credentials_policy','scramble.ui.layout','scramble.servers.Local','scramble.servers.Staging','scramble.enum_cases_description_strategy',
...
'dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','boost.enabled','boost.browser_logs_watcher','boost.rules.enabled',
...
'boost.browser_log_levels','mcp.redirect_domains','mcp.custom_schemes','mcp.authorization_server','nightwatch.enabled',
