...
'app','mail.orders.created','mail.orders.created-text','mail::html.button','mail::html.button',
'mail::html.footer','mail::html.footer','mail::html.header','mail::html.header','mail::html.layout',
'mail::html.layout','mail::html.message','mail::html.message','mail::html.panel','mail::html.panel',
'mail::html.subcopy','mail::html.subcopy','mail::html.table','mail::html.table','mail::orders.created',
'mail::orders.created-text','mail::text.button','mail::text.button','mail::text.footer','mail::text.footer',
'mail::text.header','mail::text.header','mail::text.layout','mail::text.layout','mail::text.message',
'mail::text.message','mail::text.panel','mail::text.panel','mail::text.subcopy','mail::text.subcopy',
'mail::text.table','mail::text.table','vendor.mail.html.button','vendor.mail.html.footer','vendor.mail.html.header',
...
'vendor.mail.text.panel','vendor.mail.text.subcopy','vendor.mail.text.table','horizon::layout','laravel-exceptions-renderer::components.card',
