...
'api.attachments.preview','api.attachments.destroy','health.up','health.check',
...
'password.confirm','logout','web.orders.show','storage.local',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','SAIL_XDEBUG_MODE','OCTANE_SERVER','OCTANE_HTTPS',
'TELESCOPE_ENABLED','SANCTUM_TOKEN_PREFIX','NIGHTWATCH_TOKEN','NIGHTWATCH_REQUEST_SAMPLE_RATE',);
