...
'viewTelescope','viewHorizon','users.create','users.delete','system.settings',
'reports.export','orders.assign','has-permission','viewAny','view',
...
'app.aliases.Vite','attachments.max_file_size','attachments.allowed_mime_types','attachments.storage_directory','attachments.storage_disk',
'attachments.preserve_original_filename','attachments.generate_thumbnails','attachments.thumbnail_dimensions.width','attachments.thumbnail_dimensions.height','auth.defaults.guard',
...
'horizon.environments.production.supervisor-1.balanceCooldown','horizon.environments.local.supervisor-1.maxProcesses','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist',
...
'logging.channels.nightwatch.driver','logging.channels.nightwatch.via','logging.channels.nightwatch.level','mail.default','mail.mailers.smtp.transport',
...
'dompdf.options.allowed_remote_hosts','dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','nightwatch.enabled','nightwatch.token',
'nightwatch.deployment','nightwatch.server','nightwatch.sampling.requests','nightwatch.sampling.commands','nightwatch.sampling.exceptions',
...
'horizon.failed-jobs.show','horizon.retry-jobs.show','horizon.jobs.show','horizon.index','sanctum.csrf-cookie','telescope','home',
...
'password.store','verification.notice','verification.verify','verification.send','password.confirm','logout','orders.show','logout','password.email','password.store','verification.notice',
'verification.verify','verification.send','attachments.download','attachments.preview','health.up','health.check','storage.local',);
        registerArgumentsSet('views', 
'lumasachi::app','lumasachi::emails.orders.created','lumasachi::emails.orders.created-text','vendor.mail.html.button','vendor.mail.html.footer',
...
'vendor.mail.text.message','vendor.mail.text.panel','vendor.mail.text.subcopy','vendor.mail.text.table','horizon::layout',
