...
'has-permission','viewHorizon','viewTelescope','viewAny','view',
...
'dompdf.options.enable_remote','dompdf.options.allowed_remote_hosts','dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','nightwatch.enabled',
...
'app','mail.orders.created','mail.orders.created-text','mail::button','mail::button',
'mail::footer','mail::footer','mail::header','mail::header','mail::html.button',
'mail::html.button','mail::html.button','mail::html.button','mail::html.button','mail::html.footer',
'mail::html.footer','mail::html.footer','mail::html.footer','mail::html.footer','mail::html.header',
'mail::html.header','mail::html.header','mail::html.header','mail::html.header','mail::html.layout',
'mail::html.layout','mail::html.layout','mail::html.layout','mail::html.layout','mail::html.message',
'mail::html.message','mail::html.message','mail::html.message','mail::html.message','mail::html.panel',
'mail::html.panel','mail::html.panel','mail::html.panel','mail::html.panel','mail::html.subcopy',
'mail::html.subcopy','mail::html.subcopy','mail::html.subcopy','mail::html.subcopy','mail::html.table',
'mail::html.table','mail::html.table','mail::html.table','mail::html.table','mail::layout',
'mail::layout','mail::message','mail::message','mail::orders.created','mail::orders.created-text',
'mail::panel','mail::panel','mail::subcopy','mail::subcopy','mail::table',
'mail::table','mail::text.button','mail::text.button','mail::text.button','mail::text.button',
'mail::text.button','mail::text.footer','mail::text.footer','mail::text.footer','mail::text.footer',
'mail::text.footer','mail::text.header','mail::text.header','mail::text.header','mail::text.header',
'mail::text.header','mail::text.layout','mail::text.layout','mail::text.layout','mail::text.layout',
'mail::text.layout','mail::text.message','mail::text.message','mail::text.message','mail::text.message',
'mail::text.message','mail::text.panel','mail::text.panel','mail::text.panel','mail::text.panel',
'mail::text.panel','mail::text.subcopy','mail::text.subcopy','mail::text.subcopy','mail::text.subcopy',
'mail::text.subcopy','mail::text.table','mail::text.table','mail::text.table','mail::text.table',
'mail::text.table','vendor.mail.html.button','vendor.mail.html.footer','vendor.mail.html.header','vendor.mail.html.layout',
...
'vendor.mail.text.subcopy','vendor.mail.text.table','horizon::layout','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','SAIL_XDEBUG_MODE',
'OCTANE_SERVER','OCTANE_HTTPS','TELESCOPE_ENABLED','SANCTUM_TOKEN_PREFIX','NIGHTWATCH_TOKEN',
