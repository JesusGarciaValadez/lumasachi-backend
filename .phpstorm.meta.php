...
'dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','boost.enabled','boost.browser_logs_watcher','mcp.redirect_domains',
...
'api.attachments.download','api.attachments.preview','api.attachments.destroy','api.catalog.engine-options','health.up',
'health.check','api.users.employees','api.users.customers','home',
...
'password.store','verification.notice','verification.verify','verification.send','password.confirm','logout','web.catalog.engine-options','web.orders.index','web.orders.show',
...
'common.loading','common.empty','orders.order','orders.orders','orders.title',
'orders.status','orders.priority','orders.customer','orders.assigned_to','orders.estimated_completion',
'orders.actual_completion','orders.notes','orders.no_notes','orders.categories','orders.created_at',
'orders.attachments','orders.history','orders.status_labels.Open','orders.status_labels.In Progress','orders.status_labels.Ready for delivery',
'orders.status_labels.Completed','orders.status_labels.Delivered','orders.status_labels.Paid','orders.status_labels.Returned','orders.status_labels.Not paid',
'orders.status_labels.On hold','orders.status_labels.Cancelled','orders.priority_labels.Low','orders.priority_labels.Normal','orders.priority_labels.High',
'orders.priority_labels.Urgent','service_catalog.wash_block','service_catalog.hone_cylinders','service_catalog.deck_block','service_catalog.pressure_test_head',
'service_catalog.seat_cut','service_catalog.valve_grinding','service_catalog.grind_crankshaft','service_catalog.polish_crankshaft','service_catalog.balance_crankshaft',
'service_catalog.resize_rods','service_catalog.press_pistons','service_catalog.install_bushings',);
