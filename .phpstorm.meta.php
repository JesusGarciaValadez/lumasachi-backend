...
'cache.stores.octane.driver','cache.prefix','cache.orders.ttl.index','cache.orders.ttl.show','cache.categories.ttl.index',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/public/storage','horizon.domain','horizon.path',
...
'logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.nightwatch.driver','logging.channels.nightwatch.via',
'logging.channels.nightwatch.level','logging.channels.browser.driver','logging.channels.browser.path','logging.channels.browser.level','logging.channels.browser.days',
...
'scramble.ui.layout','scramble.servers.Local','scramble.servers.Staging','scramble.enum_cases_description_strategy','scramble.middleware',
'scramble.extensions','services.postmark.token','services.resend.key','services.ses.key','services.ses.secret',
...
'dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','boost.enabled','boost.browser_logs_watcher','nightwatch.enabled',
'nightwatch.token','nightwatch.deployment','nightwatch.server','nightwatch.capture_exception_source_code','nightwatch.sampling.requests',
...
'nightwatch.ingest.connection_timeout','nightwatch.ingest.event_buffer','pennant.default','pennant.stores.array.driver','pennant.stores.database.driver',
...
'api.attachments.download','api.attachments.preview','api.attachments.destroy','health.up','health.check',
'api.users.employees','api.users.customers','home','dashboard','profile.edit','profile.update','profile.destroy','password.edit',
...
'logout','web.orders.index','web.orders.show','storage.local','scramble.docs.ui',
...
'horizon::layout','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.copy-button','laravel-exceptions-renderer::components.editor',
...
'common.dashboard','common.orders','common.recent_orders','common.view_more','common.loading',
'common.empty','orders.order','orders.orders','orders.title','orders.status',
'orders.priority','orders.customer','orders.assigned_to','orders.estimated_completion','orders.actual_completion',
'orders.notes','orders.no_notes','orders.categories','orders.created_at','orders.attachments',
'orders.history','orders.status_labels.Open','orders.status_labels.In Progress','orders.status_labels.Ready for delivery','orders.status_labels.Completed',
'orders.status_labels.Delivered','orders.status_labels.Paid','orders.status_labels.Returned','orders.status_labels.Not paid','orders.status_labels.On hold',
'orders.status_labels.Cancelled','orders.priority_labels.Low','orders.priority_labels.Normal','orders.priority_labels.High','orders.priority_labels.Urgent',);
