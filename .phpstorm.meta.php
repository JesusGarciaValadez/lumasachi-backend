...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.categories.ttl.index' => 'string',
...
'cache.prefix','cache.orders.ttl.index','cache.orders.ttl.show','cache.categories.ttl.index','cache.order_histories.ttl.index',
'cache.order_histories.ttl.show','database.default','database.connections.sqlite.driver','database.connections.sqlite.url','database.connections.sqlite.database',
...
'database.redis.horizon.database','database.redis.horizon.options.prefix','features.motor-items.disabled','features.motor-items.rollout_date','filesystems.default',
...
'horizon.environments.local.supervisor-1.maxProcesses','horizon.watch','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist',
...
'logging.channels.emergency.path','logging.channels.nightwatch.driver','logging.channels.nightwatch.via','logging.channels.nightwatch.level','logging.channels.browser.driver',
...
'api.orders.status.update','api.orders.assign','api.orders.history','api.orders.attachments.index','api.orders.attachments.store',
...
'api.orders.track','api.attachments.download','api.attachments.preview','api.attachments.destroy','api.catalog.engine-options',
'health.up','health.check','api.users.employees','api.users.customers',
...
'password.confirm','logout','web.catalog.engine-options','web.orders.index',
'web.orders.show','storage.local','scramble.docs.ui','scramble.docs.document',);
...
'orders.no_notes','orders.categories','orders.created_at','orders.attachments','orders.history',
'orders.status_labels.Received','orders.status_labels.Awaiting Review','orders.status_labels.Reviewed','orders.status_labels.Awaiting Customer Approval','orders.status_labels.Ready for Work',
'orders.status_labels.Open','orders.status_labels.In Progress','orders.status_labels.Ready for Delivery','orders.status_labels.Completed','orders.status_labels.Delivered',
'orders.status_labels.Paid','orders.status_labels.Returned','orders.status_labels.Not Paid','orders.status_labels.On Hold','orders.status_labels.Cancelled',
...
'service_catalog.wash_head_4cyl','service_catalog.wash_head_v6','service_catalog.wash_head_v8','service_catalog.pressure_test_head_4cyl','service_catalog.pressure_test_head_v6v8',
'service_catalog.surface_head_4cyl','service_catalog.surface_head_v6v8','service_catalog.spot_weld_head','service_catalog.kline_guide_pu','service_catalog.insert_guide_pu',
'service_catalog.grind_seat_pu','service_catalog.machine_seat_pu','service_catalog.sleeve_seat_pu','service_catalog.valve_grinding','service_catalog.calibrate_16v',
'service_catalog.assemble_16v','service_catalog.lifter_service','service_catalog.straighten_head','service_catalog.straighten_head_diesel','service_catalog.stud_thread_repair',
'service_catalog.spark_plug_thread','service_catalog.triton_special_thread','service_catalog.wash_block','service_catalog.bore_cylinder_pu','service_catalog.sleeve_cylinder_pu',
'service_catalog.hone_cylinder_pu','service_catalog.align_bore_main_4cyl','service_catalog.hone_main_4cyl','service_catalog.deck_block_4cyl','service_catalog.deck_block_6cyl',
'service_catalog.deck_block_8cyl','service_catalog.deck_assembled_4cyl','service_catalog.deck_assembled_v6','service_catalog.replace_cam_bearings','service_catalog.polish_camshaft_bars',
'service_catalog.weld_between_cylinders_qr25','service_catalog.polish_crank_4cyl','service_catalog.polish_crank_6cyl','service_catalog.polish_crank_8cyl','service_catalog.grind_crank_4cyl',
'service_catalog.grind_crank_6cyl','service_catalog.grind_crank_8cyl','service_catalog.straighten_crank','service_catalog.fill_thrust','service_catalog.fill_journal',
'service_catalog.dynamic_balance_4cyl','service_catalog.dynamic_balance_6cyl','service_catalog.dynamic_balance_8cyl','service_catalog.resize_rods_4','service_catalog.fit_rods_to_crank_4',
'service_catalog.press_pistons_4','service_catalog.clip_pistons_4','service_catalog.vw_wash_head','service_catalog.vw_pressure_test','service_catalog.vw_surface_head',
'service_catalog.vw_guide_replacement','service_catalog.vw_seat_grind','service_catalog.vw_valve_adjust','service_catalog.vw_bore_cylinders','service_catalog.vw_crank_polish',
'service_catalog.vw_crank_grind','service_catalog.vw_full_rebuild',);
