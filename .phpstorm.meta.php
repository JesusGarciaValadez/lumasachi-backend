...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'features.motor-items.rollout_date' => 'NULL',
...
'app.aliases.View','app.aliases.Vite','attachments.max_file_size','attachments.allowed_mime_types','attachments.storage_directory',
'attachments.storage_disk','attachments.preserve_original_filename','attachments.generate_thumbnails','attachments.thumbnail_dimensions.width','attachments.thumbnail_dimensions.height',
...
'cache.prefix','cache.orders.ttl.index','cache.orders.ttl.show','cache.order_histories.ttl.index','cache.order_histories.ttl.show',
...
'database.redis.horizon.options.prefix','features.motor-items.disabled','features.motor-items.rollout_date','filesystems.default','filesystems.disks.local.driver',
...
'horizon.watch','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist','inertia.page_paths',
...
'octane.max_execution_time','pennant.default','pennant.stores.array.driver','pennant.stores.database.driver','pennant.stores.database.connection',
'pennant.stores.database.table','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'scramble.ui.layout','scramble.servers.Local','scramble.servers.Staging','scramble.enum_cases_description_strategy','scramble.enum_cases_names_strategy',
'scramble.flatten_deep_query_parameters','scramble.middleware','scramble.extensions','services.postmark.token','services.resend.key',
...
'dompdf.options.enable_html5_parser','boost.enabled','boost.browser_logs_watcher','boost.executable_paths.php','boost.executable_paths.composer',
'boost.executable_paths.npm','boost.executable_paths.vendor_bin','mcp.redirect_domains','nightwatch.enabled','nightwatch.token',
'nightwatch.deployment','nightwatch.server','nightwatch.capture_exception_source_code','nightwatch.capture_request_payload','nightwatch.redact_payload_fields',
'nightwatch.redact_headers','nightwatch.sampling.requests','nightwatch.sampling.commands','nightwatch.sampling.exceptions','nightwatch.sampling.scheduled_tasks',
...
'password.store','verification.notice','verification.verify','verification.send','api.orders.index','api.orders.store','api.orders.show',
'api.orders.update','api.orders.destroy','api.orders.status.update','api.orders.assign','api.orders.history',
'api.orders.attachments.index','api.orders.attachments.store','api.orders.budget','api.orders.customer-approval','api.orders.work-completed',
'api.orders.ready-for-delivery','api.orders.deliver','api.orders.track','api.attachments.download','api.attachments.preview',
...
'validation.custom.attribute-name.rule-name','common.dashboard','common.orders','common.recent_orders','common.view_more',
'common.loading','common.empty','notifications.greeting','notifications.greeting_admin','notifications.salutation',
'notifications.view_order','notifications.order_received.subject','notifications.order_received.line','notifications.order_reviewed.subject','notifications.order_reviewed.line',
'notifications.order_reviewed.action','notifications.order_ready_for_work.subject','notifications.order_ready_for_work.line','notifications.order_ready_for_delivery.subject','notifications.order_ready_for_delivery.line',
'notifications.order_delivered.subject','notifications.order_delivered.line','notifications.order_paid.subject','notifications.order_paid.line','notifications.audit.subjects.created',
'notifications.audit.subjects.reviewed','notifications.audit.subjects.ready_for_work','notifications.audit.subjects.customer_approved','notifications.audit.subjects.work_completed','notifications.audit.subjects.delivered',
'notifications.audit.subjects.received','notifications.audit.subjects.paid','notifications.audit.subjects.service_completed','notifications.audit.subjects.default','notifications.audit.line',
'notifications.audit.event','notifications.audit.order','notifications.audit.status','notifications.order_label','notifications.status_label',
'orders.order','orders.orders','orders.title','orders.status','orders.priority',
'orders.customer','orders.assigned_to','orders.estimated_completion','orders.actual_completion','orders.notes',
'orders.no_notes','orders.created_at','orders.attachments','orders.history','orders.status_labels.Received',
'orders.status_labels.Awaiting Review','orders.status_labels.Reviewed','orders.status_labels.Awaiting Customer Approval','orders.status_labels.Ready for Work','orders.status_labels.Open',
'orders.status_labels.In Progress','orders.status_labels.Ready for Delivery','orders.status_labels.Completed','orders.status_labels.Delivered','orders.status_labels.Paid',
'orders.status_labels.Returned','orders.status_labels.Not Paid','orders.status_labels.On Hold','orders.status_labels.Cancelled','orders.validation.mark_ready_for_delivery_status',
'orders.priority_labels.Low','orders.priority_labels.Normal','orders.priority_labels.High','orders.priority_labels.Urgent','service_catalog.wash_head_4cyl',
'service_catalog.wash_head_v6','service_catalog.wash_head_v8','service_catalog.pressure_test_head_4cyl','service_catalog.pressure_test_head_v6v8','service_catalog.surface_head_4cyl',
'service_catalog.surface_head_v6v8','service_catalog.spot_weld_head','service_catalog.kline_guide_pu','service_catalog.insert_guide_pu','service_catalog.grind_seat_pu',
'service_catalog.machine_seat_pu','service_catalog.sleeve_seat_pu','service_catalog.valve_grinding','service_catalog.calibrate_16v','service_catalog.assemble_16v',
'service_catalog.lifter_service','service_catalog.straighten_head','service_catalog.straighten_head_diesel','service_catalog.stud_thread_repair','service_catalog.spark_plug_thread',
'service_catalog.triton_special_thread','service_catalog.wash_block','service_catalog.bore_cylinder_pu','service_catalog.sleeve_cylinder_pu','service_catalog.hone_cylinder_pu',
'service_catalog.align_bore_main_4cyl','service_catalog.hone_main_4cyl','service_catalog.deck_block_4cyl','service_catalog.deck_block_6cyl','service_catalog.deck_block_8cyl',
'service_catalog.deck_assembled_4cyl','service_catalog.deck_assembled_v6','service_catalog.replace_cam_bearings','service_catalog.polish_camshaft_bars','service_catalog.weld_between_cylinders_qr25',
'service_catalog.polish_crank_4cyl','service_catalog.polish_crank_6cyl','service_catalog.polish_crank_8cyl','service_catalog.grind_crank_4cyl','service_catalog.grind_crank_6cyl',
'service_catalog.grind_crank_8cyl','service_catalog.straighten_crank','service_catalog.fill_thrust','service_catalog.fill_journal','service_catalog.dynamic_balance_4cyl',
'service_catalog.dynamic_balance_6cyl','service_catalog.dynamic_balance_8cyl','service_catalog.resize_rods_4','service_catalog.fit_rods_to_crank_4','service_catalog.press_pistons_4',
'service_catalog.clip_pistons_4','service_catalog.vw_wash_head','service_catalog.vw_pressure_test','service_catalog.vw_surface_head','service_catalog.vw_guide_replacement',
'service_catalog.vw_seat_grind','service_catalog.vw_valve_adjust','service_catalog.vw_bore_cylinders','service_catalog.vw_crank_polish','service_catalog.vw_crank_grind',
'service_catalog.vw_full_rebuild','service_catalog.vw_sleeve_020_080','service_catalog.vw_misc_thread_repair','service_catalog.vw_head_refaced_valves','service_catalog.vw_head_new_valves',
'service_catalog.vw_crank_assembly','service_catalog.vw_axial_play_check','service_catalog.vw_connecting_rods','service_catalog.vw_knurled_rods','service_catalog.vw_pulley_weld',
'service_catalog.vw_spool_weld','service_catalog.vw_camshaft_spool_weld','service_catalog.vw_bearing_set',);
...
'NIGHTWATCH_TOKEN','NIGHTWATCH_REQUEST_SAMPLE_RATE',);
