...
'viewTelescope','users.create','users.delete','system.settings','reports.export',
'orders.assign','has-permission','viewHorizon','viewAny','view',
...
'horizon.failed-jobs.show','horizon.retry-jobs.show','horizon.jobs.show','horizon.index','sanctum.csrf-cookie','telescope',
...
'app','mail.orders.created','mail.orders.created-text','horizon::layout','laravel-exceptions-renderer::components.card',
