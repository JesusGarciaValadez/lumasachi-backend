...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.maintainer_email' => 'NULL',
            'app.supported_locales' => 'array',
            'attachments.max_file_size' => 'integer',
            'attachments.allowed_mime_types' => 'array',
            'attachments.storage_directory' => 'string',
            'attachments.storage_disk' => 'string',
            'attachments.preserve_original_filename' => 'boolean',
            'attachments.generate_thumbnails' => 'boolean',
            'attachments.thumbnail_dimensions.width' => 'integer',
            'attachments.thumbnail_dimensions.height' => 'integer',
            ...
            'cache.prefix' => 'string',
            'cache.orders.ttl.index' => 'string',
            'cache.orders.ttl.show' => 'string',
            'cache.order_histories.ttl.index' => 'string',
            'cache.order_histories.ttl.show' => 'string',
            ...
            'features.motor-items.disabled' => 'boolean',
            'features.motor-items.rollout_date' => 'string',
            ...
            'scramble.servers.Local' => 'string',
            'scramble.servers.Staging' => 'string',
...
'users.create','users.delete','system.settings','reports.export','orders.assign',
'has-permission','viewApiDocs','viewHorizon','viewTelescope','viewAny',
'view','create','update','approve','delete',
'restore','forceDelete','assign','__construct','reject',);
...
'app.aliases.View','app.aliases.Vite','app.maintainer_email','app.supported_locales','attachments.max_file_size',
'attachments.allowed_mime_types','attachments.storage_directory','attachments.storage_disk','attachments.preserve_original_filename','attachments.generate_thumbnails',
'attachments.thumbnail_dimensions.width','attachments.thumbnail_dimensions.height','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'cache.stores.failover.driver','cache.stores.failover.stores','cache.prefix','cache.orders.ttl.index','cache.orders.ttl.show',
'cache.order_histories.ttl.index','cache.order_histories.ttl.show','database.default','database.connections.sqlite.driver','database.connections.sqlite.url',
...
'database.redis.horizon.port','database.redis.horizon.database','database.redis.horizon.options.prefix','features.motor-items.disabled','features.motor-items.rollout_date',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/public/storage','horizon.name','horizon.domain',
...
'sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','scramble.api_path','scramble.api_domain',
...
'scramble.servers.Local','scramble.servers.Staging','scramble.enum_cases_description_strategy','scramble.enum_cases_names_strategy','scramble.flatten_deep_query_parameters',
'scramble.middleware','scramble.extensions','services.postmark.token','services.resend.key','services.ses.key',
...
'debugbar.cache.delete','debugbar.queries.explain','boost.browser-logs','dusk.login','dusk.logout',
'dusk.user','horizon.stats.index','horizon.workload.index','horizon.masters.index','horizon.monitoring.index',
...
'horizon.retry-jobs.show','horizon.jobs.show','horizon.index','sanctum.csrf-cookie','telescope','logout','password.email','password.store','verification.notice',
'verification.verify','verification.send',
'api.orders.index','api.orders.store','api.orders.show','api.orders.update','api.orders.destroy',
'api.orders.status.update','api.orders.payments.store','api.orders.refunds.store','api.orders.refunds.approve','api.orders.refunds.reject',
'api.orders.refunds.process','api.orders.assign','api.orders.history','api.orders.attachments.index','api.orders.attachments.store',
'api.orders.budget','api.orders.customer-approval','api.orders.work-completed','api.orders.ready-for-delivery','api.orders.deliver',
'api.orders.track','api.orders.public.attachments.download','api.orders.public.attachments.preview','api.attachments.download','api.attachments.preview',
'api.attachments.destroy','api.catalog.engine-options','health.up','health.check','api.users.employees',
'api.users.customers','home','locale.update','dashboard','profile.edit','profile.update','profile.destroy','password.edit',
'password.update','appearance','language.edit','register',
'login','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','password.confirm','logout','web.catalog.engine-options','web.orders.track','web.orders.index',
'web.orders.create','web.orders.show','storage.local','storage.local.upload','scramble.docs.ui',
'scramble.docs.document',);
        registerArgumentsSet('views', 
'app','mail.orders.created','mail::button','mail::button','mail::footer',
'mail::footer','mail::header','mail::header','mail::html.button','mail::html.button',
'mail::html.button','mail::html.button','mail::html.button','mail::html.footer','mail::html.footer',
'mail::html.footer','mail::html.footer','mail::html.footer','mail::html.header','mail::html.header',
'mail::html.header','mail::html.header','mail::html.header','mail::html.layout','mail::html.layout',
'mail::html.layout','mail::html.layout','mail::html.layout','mail::html.message','mail::html.message',
'mail::html.message','mail::html.message','mail::html.message','mail::html.panel','mail::html.panel',
'mail::html.panel','mail::html.panel','mail::html.panel','mail::html.subcopy','mail::html.subcopy',
'mail::html.subcopy','mail::html.subcopy','mail::html.subcopy','mail::html.table','mail::html.table',
'mail::html.table','mail::html.table','mail::html.table','mail::layout','mail::layout',
'mail::message','mail::message','mail::orders.created','mail::panel','mail::panel',
'mail::subcopy','mail::subcopy','mail::table','mail::table','mail::text.button',
'mail::text.button','mail::text.button','mail::text.button','mail::text.button','mail::text.footer',
'mail::text.footer','mail::text.footer','mail::text.footer','mail::text.footer','mail::text.header',
'mail::text.header','mail::text.header','mail::text.header','mail::text.header','mail::text.layout',
'mail::text.layout','mail::text.layout','mail::text.layout','mail::text.layout','mail::text.message',
'mail::text.message','mail::text.message','mail::text.message','mail::text.message','mail::text.panel',
'mail::text.panel','mail::text.panel','mail::text.panel','mail::text.panel','mail::text.subcopy',
'mail::text.subcopy','mail::text.subcopy','mail::text.subcopy','mail::text.subcopy','mail::text.table',
'mail::text.table','mail::text.table','mail::text.table','mail::text.table','vendor.mail.html.button',
...
'validation.custom.attribute-name.rule-name','attachments.uploaded','attachments.uploaded_many','attachments.upload_failed','attachments.download_unauthorized',
'attachments.preview_unauthorized','attachments.delete_unauthorized','attachments.not_found','attachments.not_previewable','attachments.not_belonging',
'attachments.deleted','attachments.delete_failed','auth.logout','auth.password_confirmed','auth.email_already_verified',
'auth.verification_link_sent','auth.email_verified','auth.user_created','auth.reset_link_sent','auth.password_updated',
'auth.profile_updated','auth.profile_deleted','catalog.invalid_item_type','common.dashboard','common.orders',
'common.recent_orders','common.view_more','common.loading','common.empty','locale.validation.locale',
'mail.order_created.subject','mail.order_created.heading','mail.order_created.subcopy','mail.order_created.details','mail.order_created.order_id',
'mail.order_created.title','mail.order_created.customer','mail.order_created.assigned_to','mail.order_created.unassigned','mail.order_created.status',
'mail.order_created.priority','mail.order_created.action','mail.order_created.thanks','motor.fallback','motor.item_types.cylinder_head',
'motor.item_types.engine_block','motor.item_types.crankshaft','motor.item_types.connecting_rods','motor.item_types.others','motor.components.cylinder_head.camshaft_covers',
'motor.components.cylinder_head.bolts','motor.components.cylinder_head.rocker_arm_shaft','motor.components.cylinder_head.wedges','motor.components.cylinder_head.springs','motor.components.cylinder_head.shims',
'motor.components.cylinder_head.valves','motor.components.cylinder_head.guides','motor.components.engine_block.bearing_caps','motor.components.engine_block.cap_bolts','motor.components.engine_block.camshaft',
'motor.components.engine_block.guides','motor.components.engine_block.bearings','motor.components.engine_block.camshaft_key','motor.components.engine_block.camshaft_gear','motor.components.crankshaft.iron_gear',
'motor.components.crankshaft.bronze_gear','motor.components.crankshaft.lock','motor.components.crankshaft.key','motor.components.crankshaft.flywheel','motor.components.crankshaft.bolt',
'motor.components.crankshaft.deflector','motor.components.connecting_rods.bolts','motor.components.connecting_rods.nuts','motor.components.connecting_rods.pistons','motor.components.connecting_rods.locks',
'motor.components.connecting_rods.bearings','motor.components.others.water_pump','motor.components.others.oil_pump','motor.components.others.oil_pan','motor.components.others.windage_tray',
'motor.components.others.intake_manifold','motor.components.others.exhaust_manifold','motor.components.others.timing_covers','notifications.greeting','notifications.greeting_admin',
'notifications.salutation','notifications.view_order','notifications.order_received.subject','notifications.order_received.line','notifications.order_reviewed.subject',
'notifications.order_reviewed.line','notifications.order_reviewed.action','notifications.order_ready_for_work.subject','notifications.order_ready_for_work.line','notifications.order_ready_for_delivery.subject',
'notifications.order_ready_for_delivery.line','notifications.order_delivered.subject','notifications.order_delivered.line','notifications.order_paid.subject','notifications.order_paid.line',
'notifications.audit.subjects.created','notifications.audit.subjects.reviewed','notifications.audit.subjects.ready_for_work','notifications.audit.subjects.customer_approved','notifications.audit.subjects.work_completed',
'notifications.audit.subjects.delivered','notifications.audit.subjects.received','notifications.audit.subjects.paid','notifications.audit.subjects.service_completed','notifications.audit.subjects.default',
'notifications.audit.events.created','notifications.audit.events.reviewed','notifications.audit.events.ready_for_work','notifications.audit.events.customer_approved','notifications.audit.events.work_completed',
'notifications.audit.events.ready_for_delivery','notifications.audit.events.delivered','notifications.audit.events.received','notifications.audit.events.paid','notifications.audit.events.service_completed',
'notifications.audit.events.default','notifications.audit.line','notifications.audit.event','notifications.audit.order','notifications.audit.status',
'notifications.order_label','notifications.status_label','notifications.priority_label','orders.order','orders.orders',
'orders.title','orders.status','orders.priority','orders.customer','orders.assigned_to',
'orders.estimated_completion','orders.actual_completion','orders.notes','orders.no_notes','orders.created_at',
'orders.attachments','orders.history','orders.payment_status_labels.Unpaid','orders.payment_status_labels.Partially Paid','orders.payment_status_labels.Paid',
'orders.refund_status_labels.Requested','orders.refund_status_labels.Approved','orders.refund_status_labels.Processed','orders.refund_status_labels.Rejected','orders.history_event_types.attribute',
'orders.history_event_types.lifecycle','orders.history_event_types.disposition','orders.history_event_types.payment','orders.history_event_types.payment_record','orders.history_event_types.refund',
'orders.public_history_updated','orders.track_not_found','orders.history_not_belonging','orders.messages.created','orders.messages.budget_submitted',
'orders.messages.services_approved','orders.messages.work_completed','orders.messages.ready_for_delivery','orders.messages.delivered','orders.messages.updated',
'orders.messages.deleted','orders.messages.status_updated','orders.messages.payment_recorded','orders.messages.refund_requested','orders.messages.refund_approved',
'orders.messages.refund_rejected','orders.messages.refund_processed','orders.messages.assigned','orders.history_messages.set','orders.history_messages.removed',
'orders.history_messages.changed','orders.history_messages.empty','orders.history_messages.boolean_true','orders.history_messages.boolean_false','orders.history_messages.fields.lifecycle_status',
'orders.history_messages.fields.disposition_status','orders.history_messages.fields.payment_status','orders.history_messages.fields.payment_record','orders.history_messages.fields.refund','orders.history_messages.fields.priority',
'orders.history_messages.fields.assigned_to','orders.history_messages.fields.title','orders.history_messages.fields.estimated_completion','orders.history_messages.fields.actual_completion','orders.history_messages.fields.notes',
'orders.history_messages.fields.item_received','orders.history_messages.fields.item_component_received','orders.history_messages.fields.service_budgeted','orders.history_messages.fields.service_authorized','orders.history_messages.fields.service_completed',
'orders.history_messages.fields.attachments','orders.status_labels.Received','orders.status_labels.Awaiting Review','orders.status_labels.Reviewed','orders.status_labels.Awaiting Customer Approval',
'orders.status_labels.Ready for Work','orders.status_labels.Ready for Delivery','orders.status_labels.Delivered','orders.status_labels.Returned','orders.status_labels.Cancelled',
'orders.validation.mark_ready_for_delivery_status','orders.priority_labels.Low','orders.priority_labels.Normal','orders.priority_labels.High','orders.priority_labels.Urgent',
'service_catalog.fallback','service_catalog.wash_head_4cyl','service_catalog.wash_head_v6','service_catalog.wash_head_v8','service_catalog.pressure_test_head_4cyl',
'service_catalog.pressure_test_head_v6v8','service_catalog.surface_head_4cyl','service_catalog.surface_head_v6v8','service_catalog.spot_weld_head','service_catalog.kline_guide_pu',
'service_catalog.insert_guide_pu','service_catalog.grind_seat_pu','service_catalog.machine_seat_pu','service_catalog.sleeve_seat_pu','service_catalog.valve_grinding',
'service_catalog.calibrate_16v','service_catalog.assemble_16v','service_catalog.lifter_service','service_catalog.straighten_head','service_catalog.straighten_head_diesel',
'service_catalog.stud_thread_repair','service_catalog.spark_plug_thread','service_catalog.triton_special_thread','service_catalog.wash_block','service_catalog.bore_cylinder_pu',
'service_catalog.sleeve_cylinder_pu','service_catalog.hone_cylinder_pu','service_catalog.align_bore_main_4cyl','service_catalog.hone_main_4cyl','service_catalog.deck_block_4cyl',
'service_catalog.deck_block_6cyl','service_catalog.deck_block_8cyl','service_catalog.deck_assembled_4cyl','service_catalog.deck_assembled_v6','service_catalog.replace_cam_bearings',
'service_catalog.polish_camshaft_bars','service_catalog.weld_between_cylinders_qr25','service_catalog.polish_crank_4cyl','service_catalog.polish_crank_6cyl','service_catalog.polish_crank_8cyl',
'service_catalog.grind_crank_4cyl','service_catalog.grind_crank_6cyl','service_catalog.grind_crank_8cyl','service_catalog.straighten_crank','service_catalog.fill_thrust',
'service_catalog.fill_journal','service_catalog.dynamic_balance_4cyl','service_catalog.dynamic_balance_6cyl','service_catalog.dynamic_balance_8cyl','service_catalog.resize_rods_4',
'service_catalog.fit_rods_to_crank_4','service_catalog.press_pistons_4','service_catalog.clip_pistons_4','service_catalog.vw_wash_head','service_catalog.vw_pressure_test',
'service_catalog.vw_surface_head','service_catalog.vw_guide_replacement','service_catalog.vw_seat_grind','service_catalog.vw_valve_adjust','service_catalog.vw_bore_cylinders',
'service_catalog.vw_crank_polish','service_catalog.vw_crank_grind','service_catalog.vw_full_rebuild','service_catalog.vw_sleeve_020_080','service_catalog.vw_misc_thread_repair',
'service_catalog.vw_head_refaced_valves','service_catalog.vw_head_new_valves','service_catalog.vw_crank_assembly','service_catalog.vw_axial_play_check','service_catalog.vw_connecting_rods',
'service_catalog.vw_knurled_rods','service_catalog.vw_pulley_weld','service_catalog.vw_spool_weld','service_catalog.vw_camshaft_spool_weld','service_catalog.vw_bearing_set',
'validation.failed','validation.password','validation.custom.required','validation.custom.required_without','validation.custom.exists',
'validation.custom.in','validation.custom.max','validation.custom.numeric','validation.custom.min','validation.custom.date',
'validation.custom.after','validation.custom.uuid','validation.custom.email','validation.custom.string','validation.custom.array',
'validation.custom.integer','validation.custom.file','validation.custom.mimes','validation.custom.mimetypes','validation.attributes.assigned_to',
'validation.attributes.attachable_id','validation.attributes.attachable_type','validation.attributes.authorized_service_ids','validation.attributes.comment','validation.attributes.completed_service_ids',
'validation.attributes.created_date','validation.attributes.customer_id','validation.attributes.descriptions','validation.attributes.description','validation.attributes.down_payment',
'validation.attributes.estimated_completion','validation.attributes.email','validation.attributes.field_changed','validation.attributes.file','validation.attributes.files',
'validation.attributes.device_name','validation.attributes.first_name','validation.attributes.item_type','validation.attributes.items','validation.attributes.items.*.components.*',
'validation.attributes.items.*.item_type','validation.attributes.locale','validation.attributes.lifecycle_status','validation.attributes.motor_info.brand','validation.attributes.motor_info.cylinder_count',
'validation.attributes.motor_info.down_payment','validation.attributes.motor_info.liters','validation.attributes.motor_info.model','validation.attributes.motor_info.year','validation.attributes.name',
'validation.attributes.names','validation.attributes.notes','validation.attributes.order_id','validation.attributes.password','validation.attributes.password_confirmation',
'validation.attributes.priority','validation.attributes.service_key','validation.attributes.services','validation.attributes.services.*.order_item_id','validation.attributes.services.*.service_key',
'validation.attributes.title','validation.attributes.last_name','validation.attributes.uuid',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_STAGING','APP_VERSION','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
'APP_MAINTENANCE_DRIVER','APP_MAINTAINER_EMAIL','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','LOG_CHANNEL',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','AWS_ENDPOINT','VITE_APP_NAME','SAIL_XDEBUG_MODE',
'OCTANE_SERVER','OCTANE_HTTPS','TELESCOPE_ENABLED','SANCTUM_TOKEN_PREFIX','SANCTUM_STATEFUL_DOMAINS',
'NIGHTWATCH_TOKEN','NIGHTWATCH_REQUEST_SAMPLE_RATE','FEATURE_MOTOR_ITEMS_DISABLED','FEATURE_MOTOR_ITEMS_ROLLOUT_DATE',);
