...
'scramble.servers.Local','scramble.servers.Staging','scramble.enum_cases_description_strategy','scramble.middleware','scramble.extensions',
...
'dompdf.options.enable_html5_parser','nightwatch.enabled','nightwatch.token','nightwatch.deployment','nightwatch.server',
'nightwatch.capture_exception_source_code','nightwatch.sampling.requests','nightwatch.sampling.commands','nightwatch.sampling.exceptions','nightwatch.filtering.ignore_cache_events',
...
'horizon.failed-jobs.show','horizon.retry-jobs.show','horizon.jobs.show','horizon.index','sanctum.csrf-cookie','telescope','logout','password.email','password.store',
'verification.notice','verification.verify','verification.send','api.orders.index',
'api.orders.store','api.orders.show','api.orders.update','api.orders.destroy','api.orders.status.update',
'api.orders.assign','api.orders.history','api.orders.attachments.index','api.orders.attachments.store','api.attachments.download',
'api.attachments.preview','api.attachments.destroy','health.up','health.check','api.users.employees',
...
'AWS_USE_PATH_STYLE_ENDPOINT','AWS_ENDPOINT','VITE_APP_NAME','SAIL_XDEBUG_MODE','OCTANE_SERVER',
'OCTANE_HTTPS','TELESCOPE_ENABLED','SANCTUM_TOKEN_PREFIX','NIGHTWATCH_TOKEN','NIGHTWATCH_REQUEST_SAMPLE_RATE',);
