...
'attachments.download','attachments.preview','health.up','health.check','home','dashboard','profile.edit',
...
'verification.send','password.confirm','logout','orders.show',
'storage.local',);
        registerArgumentsSet('views', 
'app','mail.orders.created','mail.orders.created-text','mail::html.button','mail::html.footer',
'mail::html.header','mail::html.layout','mail::html.message','mail::html.panel','mail::html.subcopy',
'mail::html.table','mail::orders.created','mail::orders.created-text','mail::text.button','mail::text.footer',
'mail::text.header','mail::text.layout','mail::text.message','mail::text.panel','mail::text.subcopy',
...
'OCTANE_SERVER','TELESCOPE_ENABLED','SANCTUM_TOKEN_PREFIX','NIGHTWATCH_TOKEN','NIGHTWATCH_REQUEST_SAMPLE_RATE',);
