...
test('administrator dashboard uses the same company scope for recent users', function (): void {
...
test('super administrators and customers receive the correct sidebar capability', function (): void {
