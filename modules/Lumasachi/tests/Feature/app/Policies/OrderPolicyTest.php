...
final class OrderPolicyTest extends TestCase
{
    ...
    public function it_checks_if_view_specific_order_permissions(): void
    {
        ...
        $orderAssignedToEmployee = Order::factory()->create([
        ...
        $orderForCustomer = Order::factory()->create([
            'customer_id' => $customer->id,
    ...
    public function it_checks_if_update_order_permissions(): void
    {
        ...
        // Create test orders
        $orderAssignedToEmployee1 = Order::factory()->create([
            'assigned_to' => $employee1->id,
            'customer_id' => $customer->id,
            'created_by' => $admin->id,
        ]);

        $orderCreatedByEmployee1 = Order::factory()->create([
    ...
    public function it_checks_if_restore_order_permissions(): void
    {
        ...
        $deletedOrderAssignedToEmployee = Order::factory()->create([
            'assigned_to' => $employee1->id,
            'customer_id' => $customer->id,
            'created_by' => $admin->id,
        ]);
