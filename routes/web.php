...
Route::middleware(['auth', 'verified', 'password.changed', 'can:viewAny,App\\Models\\Order'])->get('catalog/engine-options', function () {
...
Route::middleware(['auth', 'verified', 'password.changed', 'can:viewAny,App\\Models\\Order'])->get('orders', [OrderPageController::class, 'index'])
    ->name('web.orders.index');

// Order intake (web) - requires ability to create orders
Route::middleware(['auth', 'verified', 'password.changed', 'can:create,App\\Models\\Order'])->get('orders/create', [OrderPageController::class, 'create'])
    ->name('web.orders.create');

// Orders show (web) - render Inertia page with server-side props
Route::middleware(['auth', 'verified', 'password.changed', 'can:view,order'])->group(function () {
