...
- [ ] All 27 Unit files use Pest syntax.
- [ ] Unit runtime counts and assertion deltas are reconciled against Step 1.
- [ ] Lifecycle, cleanup, factory, migration, and seeder behavior remains covered.
- [ ] Unit, serial full-suite, and parallel full-suite gates pass.
...
- [ ] Foundational Feature files use Pest syntax.
- [ ] Auth, settings, localization, and Inertia assertions are preserved.
...
- [ ] All 18 domain-supporting Feature files use Pest syntax.
- [ ] Cleanup, role matrices, observers, mail, notifications, and validation remain covered.
- [ ] Focused and full-suite gates pass.
...
Use exact files for each group. Example:

```bash
vendor/bin/sail php vendor/bin/pest --drift tests/Feature/app/Http/Controllers/HealthControllerTest.php
...
- [ ] All 18 controller files use Pest syntax.
- [ ] Every business-rule invariant listed in this plan remains represented by passing assertions.
- [ ] Each subgroup and the entire suite pass.
